...
public class Champion {
	...
	public Champion(float hp, float hpReg, float mana, float manaReg, float attackDamage, float attackSpeed, float armor, float magicResistance
			, float movementSpeed, float Range){
		this.hp=hp;
		this.hpReg=hpReg;
		this.mana=mana;
